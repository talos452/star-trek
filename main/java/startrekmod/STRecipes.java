...
public final class STRecipes
{
	...
	static void initRecipes()
	{
		...
		GameRegistry.addRecipe (new ItemStack (STItem.batleth), new Object[] {"  D", " DS", "DS ", 'D',
			STItem.duraniumIngot, 'S', Items.stick});
		GameRegistry.addRecipe (new ItemStack (STItem.phaserDrill), new Object[] {"DUC", " UU", " UU", 'D',
			STItem.dilithiumCrystal, 'U', STItem.duraniumIngot, 'C', Items.compass});
		GameRegistry.addRecipe (new ItemStack (STItem.gagh), new Object[] {"D", "B", 'D', Blocks.dirt, 'B',
			Items.bowl});
	}
	...
	static void initShapelessRecipes()
	{
		...
		GameRegistry.addShapelessRecipe (new ItemStack (STItem.powerCell), new Object[] {STItem.duraniumIngot,
			Items.redstone});
		GameRegistry.addShapelessRecipe (new ItemStack (STItem.goldLatinum, 2), new Object[] {STItem.latinumIngot,
			Items.gold_ingot});
	}
