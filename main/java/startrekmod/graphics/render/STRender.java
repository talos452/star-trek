...
public abstract class STRender extends Render
{
    ...
    @Override
    public final void doRender (Entity entity, double translationX, double translationY, double translationZ,
                    float yaw, float pitch)
    {
        /*
         * rotationYaw is measured counterclockwise from 3:00 if you are looking
         * up with your head west. rotationPitch is measured counterclockwise
         * from 3:00 if you are looking west with your head up.
         */
